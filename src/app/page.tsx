        ...
        <div className="col-span-3">
          <Card>
            <div className="space-y-2">
              ...
              <p className="text-3xl font-bold text-text-primary">{serverStats.ok ? serverStats.data.data.activeUsers : "N/A"}</p>
              <p className="text-xs text-accent-primary">{serverStats.ok ? serverStats.data.data.connectedUsers : "N/A"} actively listening</p>
            </div>
          </Card>
        </div>
        <div className="col-span-3">
          <Card>
            <div className="space-y-2">
              ...
              <p className="text-3xl font-bold text-text-primary">{serverStats.ok ? serverStats.data.data.musicVideos : "N/A"}</p>
        ...
        <div className="col-span-3">
          <Card>
            <div className="space-y-2">
              ...
              <p className="text-3xl font-bold text-text-primary">{serverStats.ok ? serverStats.data.data.musicArtists : "N/A"}</p>
        ...
        <div className="col-span-3">
          <Card>
            <div className="space-y-2">
              ...
              <p className="text-3xl font-bold text-text-primary">{serverStats.ok ? Math.round(serverStats.data.data.totalListenedHours) : "N/A"}</p>
          ...
          <Card>
            <div className="space-y-4 h-full flex flex-col">
              ...
              <p className="text-text-secondary">
                Share what you're listening to in real-time via <span className="text-accent-primary">Websocket</span> or <span className="text-accent-primary">Embeds</span>.
                Keep your followers updated with live progress tracking.
              </p>
        ...
        <div className="col-span-4 row-span-2">
          <Card>
            <div className="space-y-4 h-full flex flex-col">
              ...
              <p className="text-text-secondary">
                Explore comprehensive statistics about your listening habits.
                View top artists, favorite genres, and activity patterns with beautiful charts.
              </p>
              <div className="flex-1" />
              <div className="bg-background-tertiary p-3 rounded-lg">
        ...
        <div className="col-span-4 row-span-2">
          <Card>
            <div className="space-y-4 h-full flex flex-col">
              ...
              <p className="text-text-secondary">
                Leverage AI to filter out videos that aren't music, ensuring accurate tracking of your listening habits.
                Normalize metadata for better insights.
              </p>
              <div className="flex-1" />
              <div className="bg-background-tertiary p-3 rounded-lg">
                ...
                <div className="space-y-2">
                  <div className="flex gap-3 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-text-secondary">Sign up quickly with your email to get started</p>
                    </div>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex gap-3 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-text-secondary">Install our browser extension to connect with YouTube</p>
                    </div>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex gap-3 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-text-secondary">Enjoy your music like you always do</p>
                    </div>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex gap-3 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-text-secondary">Explore your stats and listening patterns</p>
                    </div>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex gap-3 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-text-secondary">Let friends see your music taste</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <Card>
            <div className="space-y-4 h-full flex flex-col">
              ...
              <p className="text-text-secondary text-sm">
                Join thousands of music lovers tracking their listening journey.
