...
export default function MusicCard({music, className}: {music: ListenedMusic; className?: string}) {
        ...
        <div
            ...
            <a href={ytUrl} target="_blank" rel="noopener noreferrer" className="h-full w-full">
                <div className={"overflow-hidden grid grid-cols-[1fr_3fr_1fr] content-center gap-2"}>
                    <div className={"relative aspect-square w-16 m-auto overflow-hidden rounded-lg shadow-2xl"}>
                    ...
                    <div className={"text-text-secondary line-clamp-1 content-center"}>
                        {music.listen_count} scrobbles
                    </div>
                </div>
            </a>
        </div>
