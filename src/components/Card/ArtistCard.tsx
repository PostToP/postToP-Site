        ...
        <div
            ...
            <a href={ytURL} target="_blank" rel="noopener noreferrer" className="h-full w-full">
                <div className={"overflow-hidden grid grid-cols-[1fr_3fr_1fr] content-center gap-2"}>
                    <div className={"relative aspect-square w-16 m-auto overflow-hidden rounded-full shadow-2xl"}>
                        <Image
                            alt={"thumbnail"}
                    ...
                    <div className={"flex flex-col justify-center break-all"}>
                        <h3 className={"line-clamp-1 font-medium"}>{artist.artist_name.replace(" - Topic", "")}</h3>
                    </div>
                    <div className={"text-text-secondary line-clamp-1 content-center"}>
                        {artist.listen_count} scrobbles
                    </div>
                </div>
            </a>
        </div>
